...
<b>CMS Selfy</b> - собственная разработка системы управления контентом. Обучаясь на некоторых вещах, проектирую панель управления и логику самого приложения. В основе системы лежит микрофреймворк Slim. Пока только в разработке. Если кто хочет присоединится, прошу использовать форк и посылать пуллреквесты. <a href="https://github.com/splincode/selfycms">Подробнее</a> <br> <br><br>
